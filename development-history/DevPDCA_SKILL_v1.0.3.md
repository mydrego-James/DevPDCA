...
This core Skill is intentionally compact.

Future or repository-specific versions may provide on-demand references for topics such as:
...
Load deeper guidance only when it materially helps the current task.
